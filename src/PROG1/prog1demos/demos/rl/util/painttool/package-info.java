 ...
 * with two demo buttons added. Class {@link programming1lunde.prog1demos.demos.rl.util.painttool.PaintDemoApp}
 * demonstrates how to extend the functionality by providing
 * a modified version of the controller class
 * ({@link programming1lunde.prog1demos.demos.rl.util.painttool.PaintDemoController})
