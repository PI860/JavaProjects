...
/*public class WallDesignerDemo extends AbstractController {
	...
	public String getTitle() {
		return "programming1lunde.abgaben.uebungsblatt1.Wall Designer";
	}
	...
	public void onButtonPressed(PaintTool ptool, int button) {
		if (button >= 0 && button < getButtonNames().length - 1)
			...
			JOptionPane.showMessageDialog(ptool.getCanvas(),
					"programming1lunde.abgaben.uebungsblatt1.Wall Designer, Version 1.0"
							+ "\nTry also mouse clicks on the canvas."
							+ "\nHave fun, R. Lunde" + currDesign,
					"About programming1lunde.abgaben.uebungsblatt1.Wall Designer", JOptionPane.INFORMATION_MESSAGE);
		} else if (button == -1) {
			container = null;
			currText = null;
		}
	...
	/** Starts the programming1lunde.abgaben.uebungsblatt1.Wall Designer. *
