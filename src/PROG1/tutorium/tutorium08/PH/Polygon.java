...
//            edges[i] = new Point((int) coordinates[2 * i], (int) coordinates[2 * i + 1]); // Passende Werte von coords nehmen, Objekt erstellen und einfügen
//        }
//    }
    ...
    /*public void smooth () {
        programming1lunde.abgaben.uebungsblatt7.pp.prog1.exercises.set07.Point[] pointsSmooth = new programming1lunde.abgaben.uebungsblatt7.pp.prog1.exercises.set07.Point[edges.length*2];
        System.out.print("{");
        for (int i = 0; i < edges.length; i++) {
            int ip1 = i+1;
